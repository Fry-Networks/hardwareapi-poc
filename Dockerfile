...
COPY --chown=app:app app.py models.py storage.py measurement_aggregator.py poc_eligibility.py algo_wallet.py /app/
COPY --chown=app:app deployment /app/deployment
COPY --chown=app:app calculator /app/calculator
